...
import { tab1Features, tab1Images } from '../Education/SolutionsData';
...
const Education = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      name: 'AMS',
      to: "/ams",
      description: 'AMS offers a precise, efficient workforce management solution using advanced biometric technology to ensure accurate attendance tracking and eliminate errors or time theft.'
    },
  ];
  ...
  return (
    ...
    >
      <Hero
        backgroundImage="/Banners/Slider3.jpg"
        ...
        subtitle="OSquare For Education"
        description="Empower students to thrive both in and outside the classroom with O Square Education’s personalized tools."
        buttonText="Try Now"
        buttonLink="/#/educationpricing"
        links={[
          { label: "For Enterprise", to: "/enterprise" },
          { label: "For Business", to: "/business" },
          { label: "For Education", to: "/education", isActive: true },
      ...
      <div className="max-w-full">
        ...
        <Solutions
          canToggle={true}
          tabsData={tabsData}
          sectionTitle="Strengthen Learners & Schools"
          sectionSubtitle="LEARNING-CENTERED SOLUTIONS"
